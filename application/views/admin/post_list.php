                ...
                <tbody>
                    <?php foreach ($articles as $article) : ?>
                        <tr>
                            ...
                            <td>
                                <div class="action">
                                    <a href="<?= site_url('article/' . $article->slug) ?>" class="button button-small button-success" target="_blank" role="button">Preview</a>
                                    <a href="<?= site_url('admin/post/edit/' . $article->id) ?>" class="button button-small button-edit" role="button">Edit</a>
